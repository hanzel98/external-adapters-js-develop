import { AdapterErrorResponse, AdapterResponse, RequestConfig, AdapterRequest, AdapterRequestData, ResultPath } from '@chainlink/types';
...
export declare class Requester {
     ...
     */
    static withResult<T>(response: AxiosResponse<T>, result?: number | string, results?: [AdapterRequest, number][]): AxiosResponseWithLiftedResult<T> | AxiosResponseWithPayloadAndLiftedResult<T>;
    static errored(jobRunID?: string, error?: AdapterError | Error | string, statusCode?: number): AdapterErrorResponse;
    /**
